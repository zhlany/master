...
var file_person_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x2e, 0x0a, 0x06, 0x50, 0x65, 0x72,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x32, 0x3b, 0x0a, 0x07, 0x53, 0x61, 0x79,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x30, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x12, 0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x50, 0x65, 0x72,
	0x73, 0x6f, 0x6e, 0x1a, 0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e,
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_person_proto_goTypes = []interface{}{
	(*Person)(nil), // 0: grpc_demo.Person
}
var file_person_proto_depIdxs = []int32{
	0, // 0: grpc_demo.SayName.SayHello:input_type -> grpc_demo.Person
	0, // 1: grpc_demo.SayName.SayHello:output_type -> grpc_demo.Person
...
func (c *sayNameClient) SayHello(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
	err := c.cc.Invoke(ctx, "/grpc_demo.SayName/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSayNameServer) SayHello(context.Context, *Person) (*Person, error) {
...
func _SayName_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_demo.SayName/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayNameServer).SayHello(ctx, req.(*Person))
	}
	return interceptor(ctx, in, info, handler)
}

var _SayName_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_demo.SayName",
